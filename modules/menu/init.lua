...
--
local _path = string.gsub(..., '%.', '/')

local MenuHelper = Group:extend{
    items = {},
    delay = 1,
    arrow = _path .. '/assets/arrow.png',
    sound = {
        confirm = _path .. '/assets/confirm.wav',
        cancel = _path .. '/assets/cancel.wav',
    },
    selected = 1,
