...
local Event = {
    ...
    play = function(self, id)
        -- print('play')
        id = tonumber(id)
        STATE.event[the.app.view.mapName]     = STATE.event[the.app.view.mapName] or {}
        STATE.event[the.app.view.mapName][id] = STATE.event[the.app.view.mapName][id] or {
            id = 1, activated = false, cycle = false
        }

        self.events = require('assets.maps.' .. the.app.view.mapName .. '.events')
        local eventId = STATE.event[the.app.view.mapName][id]
    ...
    before = function(self, id)
        -- print('before')
        id = tonumber(id)
        local eventId = STATE.event[the.app.view.mapName][id]['id']
