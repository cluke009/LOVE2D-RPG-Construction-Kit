...
-- arc.fn.f = lg.newImageFont('helpers/navi/fonts/font.png'," abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789.,!?-+/():;%&`'*#=[]\"")
...
-- images
arc.img = {
	cursor = lg.newImage('helpers/navi/pics/cursor.png'),
	blinker = lg.newImage('helpers/navi/pics/press.png')
}

-- sound effects
arc.sfx = {
	cursor = la.newSource('helpers/navi/sounds/cursor.wav','static'),
	confirm = la.newSource('helpers/navi/sounds/confirm.wav','static')
}
